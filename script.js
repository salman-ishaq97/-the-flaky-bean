...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (
        ...
        console.error("Cart elements are missing from index.html.");
        return;
    }


    let cart =
        JSON.parse(localStorage.getItem("flakyBeanCart")) || [];
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (
        ...
        console.error("Order form elements are missing.");
        return;
    }
    ...
    function getCart() {
        ...
        return JSON.parse(
            localStorage.getItem("flakyBeanCart")
        ) || [];
    }
